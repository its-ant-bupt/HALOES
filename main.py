...
def get_argparse():
    ...
    parse.add_argument("--path_num", type=int, default=7, help="The number of case.")
    ...
    parse.add_argument("--sample_time", type=float, default=0.3, help="The sample time.")
    parse.add_argument("--pre_length", type=int, default=10, help="The prediction horizon.")
    parse.add_argument("--obca_sample_time", type=float, default=0.5, help="The sample time of OBCA.")
...
if __name__ == '__main__':
    ...
    mpc_optimizer.generate_object(disCostFinal=50000, deltaCostFinal=10000, disCost=1000, deltaCost=5000,
                                  aCost=0, steerCost=0, obsPower=2)
    ...
    show(final_path, case, path_num, exp_name+"-init")
    show(obcaPath, case, path_num, exp_name+"-obca")
    obcaPath_5gap = Path(path_x[::5], path_y[::5], path_yaw[::5])
    show(obcaPath_5gap, case, path_num, exp_name+"-5gap")
    ...
    saveCsv(path_t=path_t, path_x=path_x, path_y=path_y, path_v=path_v, path_yaw=path_yaw, path_a=path_a,
            ...
            sampleT=sampleT, exp_name=exp_name, path_num=path_num)
