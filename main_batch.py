...
def get_argparse():
    ...
    parse.add_argument("--path_num", type=int, default=8, help="The number of case.")
    ...
    parse.add_argument("--sample_time", type=float, default=0.25, help="The sample time.")
    ...
    parse.add_argument("--test_batch", type=int, default=10, help="The total test batch.")
